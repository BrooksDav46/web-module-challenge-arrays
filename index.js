...
Use the removeFlavorByName function below to do the following:
    ...
    For example: running removeFlavorByName(originalFlavors, "Rocky Road") would return an array with a length of 30 because Rocky Road would have been removed. 
